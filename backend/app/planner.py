...
TECHNIQUES = {
    ...
    "distill": {
        "label": "Knowledge Distillation (real training)", "auto": True, "frameworks": ("pytorch",),
        "size": 0.30, "latency": {"mlp": 0.35, "hybrid": 0.35, "cnn": 0.40, "onnx-graph": 0.40},
        "memory": 0.35, "accuracy": 0.97,
        "why": "Trains a smaller student against this model with a real "
               "optimizer loop (Adam, teacher soft targets): measured loss "
               "curve, real weights, real artifact.",
    },
}

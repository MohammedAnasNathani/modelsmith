...
cp ../frontend/index.html ../frontend/style.css ../frontend/charts.js \
   ../frontend/landing.js ../frontend/landing-data.json ../frontend/live-url.json ../frontend/icon-192.png ../frontend/icon-512.png ../frontend/logo.svg ../frontend/favicon.svg ../frontend/manifest.json \
